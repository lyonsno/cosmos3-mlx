"""Text-to-video generation with Cosmos 3 Nano on MLX."""
...
def main():
    parser = argparse.ArgumentParser(description="Cosmos 3 Nano text-to-video generation")
    ...
    print(f"\nGenerating {args.width}x{args.height} {args.num_frames}-frame video...")
